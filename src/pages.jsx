  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-shadow-950 px-4 py-8 text-neutral-100">
      ...
      <div className="relative w-full max-w-md">
        ...
        <Card className="mt-8 p-6 shadow-2xl sm:p-8">
          <div className="mb-6">
        ...
        <p className="mt-6 text-center text-[10px] font-mono tracking-[0.18em] text-neutral-700">
          MADE BY SAMARTH 🍁
        </p>
      </div>
    </div>
...
function Register() {
  ...
  function handleSubmit(event) {
    ...
    setTimeout(() => {
      ...
      setMessage({
        type: "success",
        text: "Frontend demo only — registration is not connected yet.",
      });
    }, 700);
  }
